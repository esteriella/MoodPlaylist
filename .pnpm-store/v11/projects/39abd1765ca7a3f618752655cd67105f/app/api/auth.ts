...
import { LoginModel, LoginResponseModel, RegisterModel } from "@/app/models/auth.models";
...
export async function loginUser(form: LoginModel): Promise<ApiResponseModel<LoginResponseModel>> {
  return apiRequest<ApiResponseModel<LoginResponseModel>>(
