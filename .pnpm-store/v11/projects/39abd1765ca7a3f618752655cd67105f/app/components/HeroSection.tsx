...
export default function HeroSection() {
  return (
    <section className="relative mx-auto flex w-full max-w-[1440px] flex-col items-center overflow-hidden px-7 pb-16 pt-12 sm:px-10 md:min-h-[680px] md:flex-row md:items-center md:px-12 md:py-16 lg:px-16">
      ...
      <div className="relative -mb-16 mt-8 flex h-[440px] w-full items-end justify-center sm:h-[520px] md:absolute md:inset-y-0 md:right-[-7%] md:mb-0 md:mt-0 md:h-auto md:w-[62%] md:justify-end lg:right-[-3%] lg:w-[60%]">
